...
const basePath = '/core-tech-1775545595622';
...
export default function Home() {
  ...
  const products = [{ n: 'Professional Web Hosting', d: 'Our professional web hosting services provide fast, secure, and reliable hosting solutions for businesses of all sizes, ensuring maximum uptime and performance for your website. With flexible plans and expert support, we help you achieve your online goals.', i: 'https://images.pexels.com/photos/17489152/pexels-photo-17489152.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Custom Web Development', d: 'Our team of expert web developers crafts custom websites that are tailored to your unique business needs, providing a seamless user experience and driving conversions. From design to deployment, we handle every aspect of your web development project.', i: 'https://images.pexels.com/photos/14553720/pexels-photo-14553720.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Mobile Application Development', d: 'We design and develop innovative mobile applications that cater to your business objectives, whether it\'s to increase engagement, drive sales, or improve customer experience. Our expert developers create apps that are user-friendly, secure, and scalable.', i: 'https://images.pexels.com/photos/54284/pexels-photo-54284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Domain Registration Services', d: 'Our domain registration services provide a simple and efficient way to secure your online identity, with a wide range of domain extensions available. We help you register, transfer, and manage your domains with ease, ensuring that your online presence is always secure.', i: 'https://images.pexels.com/photos/4160092/pexels-photo-4160092.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Technical Inquiries and Consulting', d: 'Our technical inquiries and consulting services offer expert guidance and support for businesses looking to leverage technology to drive growth and success. Our team of experts provides personalized advice and recommendations, helping you make informed decisions about your technology investments.', i: 'https://images.pexels.com/photos/7709227/pexels-photo-7709227.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                Core Tech is a leading technology solutions provider based in Kuching, dedicated to delivering innovative and customer-centric services. With a strong focus on web development, hosting, and application development, we strive to meet the evolving needs of our clients. Our team of experts is committed to providing exceptional support and guidance throughout every project.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">To be the most trusted and preferred technology solutions provider in Kuching, driving business growth and success for our clients through innovative and effective solutions.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">To deliver high-quality, customer-focused technology solutions that exceed our clients\' expectations, while fostering a culture of innovation, excellence, and continuous improvement.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Customer first</h4>
                  <p className="text-sm text-on-surface-variant">At Core Tech, we prioritize our customers\' needs and strive to provide personalized support and service, ensuring that their goals and objectives are met with utmost satisfaction and care.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Innovation</h4>
                  <p className="text-sm text-on-surface-variant">We believe in embracing innovation and staying at the forefront of the latest technologies and trends, enabling us to develop cutting-edge solutions that drive business success and growth for our clients.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              ...
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/9432947/pexels-photo-9432947.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
